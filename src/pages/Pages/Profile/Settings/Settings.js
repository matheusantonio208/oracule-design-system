                                ...
                                <CardBody>
                                    <div className="d-flex align-items-center mb-5">
                                        ...
                                        <div className="flex-shrink-0">
                                            <Link to="#" className="badge bg-secondary text-primary fs-12"><i
                            ...
                            <Card>
                                <CardBody>
                                    <div className="d-flex align-items-center mb-4">
                                        ...
                                        <div className="flex-shrink-0">
                                            <Link to="#" className="badge bg-secondary text-secondary fs-12"><i
                                                className="ri-add-fill align-bottom me-1"></i> Add</Link>
                                        </div>
                                    </div>
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                            <span className="avatar-title rounded-circle fs-16 bg-soft-dark text-dark">
                                    ...
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                            <span className="avatar-title rounded-circle fs-16 bg-soft-primary text-primary">
                                    ...
                                    <div className="mb-3 d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                            <span className="avatar-title rounded-circle fs-16 bg-soft-success text-success">
                                    ...
                                    <div className="d-flex">
                                        <div className="avatar-xs d-block flex-shrink-0 me-3">
                                            <span className="avatar-title rounded-circle fs-16 bg-soft-danger text-danger">
