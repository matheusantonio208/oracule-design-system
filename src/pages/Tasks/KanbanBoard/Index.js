...
import { Button, Card, CardBody, Col, Container, Form, Input, Label, Modal, ModalHeader, Row } from 'reactstrap';
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <Modal id="addmemberModal" isOpen={modal_member} toggle={() => { tog_member(); }} className="border-0">
                        <ModalHeader className="modal-header p-3 bg-soft-warning">
                            Add Member
                    ...
                    <Modal isOpen={modal_board} toggle={() => { tog_board(); }} centered id="createboardModal" className="border-0">
                        <ModalHeader className="p-3 bg-soft-info">
                            Add Board
                            <Button type="button" onClick={() => { setmodal_board(false); }} id="btn-close" className="btn-close" aria-label="Close" >
                            </Button>
                        </ModalHeader>
                        <div className="modal-body">
                            <Form action="#">
                        ...
                        <div className="modal-body">
                            <div className="mt-2 text-center">
                                <lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop"
                                    colors="primary:#FFBC0A,secondary:#f06548" style={{ width: "100px", height: "100px" }}></lord-icon>
